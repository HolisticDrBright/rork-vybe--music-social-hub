...
enum Mock {
    ...
    static let fanFirstValues: [(icon: String, title: String, description: String)] = [
        ...
        ("heart.text.square.fill", "Artist-First Economics", "Fan support goes directly to the artist — no label machine, no hidden cuts. Compare: Spotify pays ~$0.004 per stream."),
